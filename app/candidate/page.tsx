...
export default function CandidatePage() {
  ...
  async function handleResumeUploaded(value: string) {
    ...
    const response = await fetch('/api/profile', { method: 'PATCH', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ ...profile, resume_url: value }) })
    const body = await response.json()
